...
nohup ${GUR} --networkid ${NETWORK_ID} --datadir $HOME/dev/ur_data.${UR_ENV} --ipcapi="admin,db,ur,debug,miner,net,shh,txpool,personal,web3" --rpcapi "db,personal,ur,eth,net,web3" --rpccorsdomain="*" --rpc --rpcaddr=127.0.0.1 --fast </dev/null > $HOME/dev/ur_data.${UR_ENV}/gur.log 2>&1 &
sleep 10
