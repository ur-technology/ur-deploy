...
BOOTNODE1_IP_ADDRESS=$(nslookup bootnode-1.ur.technology | awk '/./{line=$0} END{print line}' | awk '{print $2}')
BOOTNODE2_IP_ADDRESS=$(nslookup bootnode-2.ur.technology | awk '/./{line=$0} END{print line}' | awk '{print $2}')
...
export BASE_GUR_OPTIONS="--networkid 1001 --datadir /home/deploy/ur_data --ipcapi='admin,db,eth,debug,miner,net,shh,txpool,personal,web3'"
