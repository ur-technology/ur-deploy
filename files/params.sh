...
BOOTNODE1_IP_ADDRESS=$(nslookup bootnode1.ur.technology | awk '/./{line=$0} END{print line}' | awk '{print $2}')
BOOTNODE2_IP_ADDRESS=$(nslookup bootnode2.ur.technology | awk '/./{line=$0} END{print line}' | awk '{print $2}')
